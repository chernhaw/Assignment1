...
function ConfirmTaskCreated(){
    ...
    <label>Select App for Task</label>
              ...
              {plan.plan_app_acronym}
               ...
               <br/>
               <div><textarea rows="5" cols="50" value={taskdescription}  onChange={(e) => { handleTaskDescriptionChange(e) }} /></div>
              
               <br/>
               <label>Task Notes</label>

               <br/>
               <div><textarea rows="7" cols="50" value={taskNotes}  onChange={(e) => { handleTaskNoteChange(e) }} /></div>
...
export default ConfirmTaskCreated